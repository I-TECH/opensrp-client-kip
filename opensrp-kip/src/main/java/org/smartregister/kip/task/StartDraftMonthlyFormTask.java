...
//            fieldsArray.put(buttonObject);
            ...
            Intent intent = new Intent(baseActivity, KipJsonFormReportsActivity.class);
    ...
    private JSONObject createFormIndicatorField(MonthlyTally monthlyTally) throws JSONException {
        ...
        int resourceId = baseActivity.getResources().getIdentifier(KipReportUtils.getStringIdentifier(monthlyTally.getIndicator()), "string", baseActivity.getPackageName());
        ...
        jsonObject.put(KipConstants.KEY.HIA_2_INDICATOR, monthlyTally.getIndicator());
        return jsonObject;
    }
