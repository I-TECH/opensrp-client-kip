...
import org.smartregister.kip.adapter.MonthlyDraftsAdapter;
import org.smartregister.kip.domain.MonthlyTally;
import org.smartregister.kip.repository.MonthlyTalliesRepository;
import org.smartregister.kip.task.FetchEditedMonthlyTalliesTask;
import org.smartregister.kip.task.FetchUneditedMonthlyTalliesTask;
...
public class DraftMonthlyFragment extends ReportFragment {
    ...
    private void updateStartNewReportButton(@Nullable final List<Date> dates) {
        ...
        if (hia2ReportsReady) {
            ...
            startNewReportDisabled.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    show(Snackbar.make(startNewReportDisabled, getString(R.string.no_monthly_ready),
    ...
    private void setupEditedDraftsView() {
        ...
        Utils.startAsyncTask(new FetchEditedMonthlyTalliesTask(reportGrouping,
                this::updateDraftsReportListView), null);
    }
