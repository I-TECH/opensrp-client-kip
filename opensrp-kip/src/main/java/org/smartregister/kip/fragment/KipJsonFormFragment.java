...
public class KipJsonFormFragment extends JsonFormFragment {
    private Snackbar snackbar = null;
    private AlertDialog alertDialog = null;
    private boolean lookedUp = false;

    public static KipJsonFormFragment getFormFragment(String stepName) {
        KipJsonFormFragment jsonFormFragment = new KipJsonFormFragment();
        Bundle bundle = new Bundle();
        bundle.putString(KipConstants.KEY.STEPNAME, stepName);
    ...
    private void clearMotherLookUp() {
        ...
        if (lookupMap.containsKey(KipConstants.KEY.MOTHER)) {
            List<View> lookUpViews = lookupMap.get(KipConstants.KEY.MOTHER);
            if (lookUpViews != null && !lookUpViews.isEmpty()) {
                ...
                metadataMap.put(KipConstants.KEY.ENTITY_ID, "");
                metadataMap.put(KipConstants.KEY.VALUE, "");
        ...
        if (pc != null) {
            ...
            if (lookupMap.containsKey(KipConstants.KEY.MOTHER)) {
                ...
                if (lookUpViews != null && !lookUpViews.isEmpty()) {
                    ...
                    Map<String, String> metadataMap = new HashMap<>();
                    metadataMap.put(KipConstants.KEY.ENTITY_ID, KipConstants.KEY.MOTHER);
                    metadataMap.put(KipConstants.KEY.VALUE, getValue(pc.getColumnmaps(), MotherLookUpUtils.baseEntityId, false));
